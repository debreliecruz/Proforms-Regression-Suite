...
public class PublishCompletedReport_RHS_Level_1 extends UserdefinedFunctions{
	...
	@Test(priority = 5)
	public void PublishCompReport_RHSLevel1() throws IOException, InterruptedException {
		ConfigFileReader();
...
//Check that Completed Report opens on a new tab
		//checkCompletedReportOpensOnNewTabLevel1();
//Rename the downloaded completed report
		renameActualReportLvl1();
		Thread.sleep(3000);
//Compare expected Draft and actual Draft reports
		compareCompletedReportsLvl1();
		Thread.sleep(4000);	
	}
@AfterTest
