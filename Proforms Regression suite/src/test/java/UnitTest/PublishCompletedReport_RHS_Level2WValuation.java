...
public class PublishCompletedReport_RHS_Level2WValuation extends UserdefinedFunctions {
	...
	@Test(priority = 6)
	public void PublishCompReport_RHSLevel2WValuation() throws IOException, InterruptedException {
		ConfigFileReader();
...
//Click New button to create new report	
	clickNewButton();
//Start creating report Level 2 with Valuation
...
//Check that Completed Report opens on a new tab
	//	checkCompletedReportOpensOnNewTabLevel2WValuation();
//Rename the downloaded completed report
		renameActualReportLvl2WValuation();
		Thread.sleep(3000);
//Compare expected Draft and actual Draft reports
		compareCompletedReportsLvl2WValuation();
		Thread.sleep(3000);	
	}
@AfterTest
